...
<section class="min-h-screen flex items-stretch text-white ">
        <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center bgstyle">
            <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            <div class="w-full px-24 z-10">
                <h1 class="text-5xl font-bold text-left tracking-wide">Disfruta de miles de contenidos</h1>
                <p class="text-3xl my-4">Disfruta de cada segundo, cada minuto, con nuestro sistema.</p>
            </div>
        ...
        <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0" style="background-color: #161616;">
            <div class="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center bgstyle">
                <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
            </div>
            <div class="w-full py-6 z-20">
                ...
                <form action="" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div class="pb-2 pt-4">
                        <input type="text" name="celular" id="celular" placeholder="Celular" class="block w-full p-4 text-lg rounded-sm bg-black">
                    </div>
                    <div class="pb-2 pt-4">
                    ...
                    <div class="px-4 pb-2 pt-4">
                        <button class="uppercase block w-full p-4 text-lg bg-indigo-500 hover:bg-indigo-600 focus:outline-none">Registrarse</button>
                    </div>
